    ...
    <div className="recipe-page">
      ...
      <div className="form-container">
        <form onSubmit={handleFormSubmit}>
          ...
          {formData.ingredients.map((ingredient, index) => (
            <div key={index} className="ingredient-row">
              <input
                ...
                onChange={(e) =>
                  handleIngredientChange(e, index, setFormData, formData)
                }
                className="input-field"
              />
              <input
          ...
          <button
            type="button"
            onClick={() => addIngredient(setFormData, formData)}
          ...
          <div className="radio-group">
            ...
            />
            <label htmlFor="write" className="radio-label">
              Write your Own
            </label>
            <input
              type="radio"
            ...
            formData.instructions.map((instruction, index) => (
              <div key={index} className="instruction-row">
                ...
                <textarea
                  ...
                  value={instruction}
                  onChange={(e) =>
                    handleInstructionChange(index, e, formData, setFormData)
                  }
                ...
                <button
                  ...
                  className="remove-button"
                  onClick={() =>
                    removeInstruction(index, formData, setFormData)
                  }
                >
                  X
                </button>
          ...
          {formData.instructionsType === "write" && (
            <button
              type="button"
              onClick={() => addInstruction(setFormData)}
              className="new-row-button"
            >
              +
            </button>
